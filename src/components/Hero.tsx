        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-8 animate-slide-up">
            <div className="relative inline-block">
              <img src={profilePhoto} alt="Profile" className="w-32 h-32 md:w-40 md:h-40 rounded-full mx-auto shadow-glow border-4 border-primary/30" />
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
            <button onClick={() => scrollToSection('about')} className="text-muted-foreground hover:text-primary transition-smooth">
